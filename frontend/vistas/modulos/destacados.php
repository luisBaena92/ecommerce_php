...
<?php 
	...
	if ($titulosModulos[0]=="ARTICULOS GRATUITOS") {
		$ordenar = "id";
		$item= "precio"; //columna de la tabla
		$valor= 0;		//valor	
						...
						foreach ($modulos[$i] as $key => $value) {
							...
							echo '  
								<li class="col-md-3 col-sm-6 col-xs-12">
									<figure>
										<a href="'.$value["ruta"].'" clas="pixelProducto">
										...
										<div class="btn-group pull-right">
											...
											if ($value["tipo"]=="virtual" && $value["precio"] !=0) {
												...
												if ($value["oferta"]!=0) {
													...
													echo '  
														<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="'.$value["id"].'" imagen="'.$servidor.$value["id"].'" titulo="'.$value["titulo"].'" precio="'.$value["precioOferta"].'" tipo="'.$value["tipo"].'" peso="'.$value["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
													...
													echo '  
														<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="'.$value["id"].'" imagen="'.$servidor.$value["id"].'" titulo="'.$value["titulo"].'" precio="'.$value["precio"].'" tipo="'.$value["tipo"].'" peso="'.$value["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
					...
					foreach ($modulos[$i] as $key => $value) {
						...
						echo'<li class="col-xs-12">
							...
							<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
								...
								<p class="text-muted">'.$value["titular"].'
								</p>';
