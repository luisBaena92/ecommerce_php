...
======================================-->
<figure class="banner">
	<img src="http://localhost/ecommerce_php/backend/vistas/img/banner/default.jpg" alt="" class="img-responsive" width="100%">
			...
			<div class="col-xs-12 organizarProductos">
				<div class="btn-group pull-right">
					<button type="button" class="btn btn-default btnGrid" id="btnGrid0">
					    ...
					    <span clas="col-xs-0 pull-right">GRID</span>
					</button>    
					<button type="button" class="btn btn-default btnList" id="btnList0">
					    <i class="fa fa-list" aria-hidden="true"></i>
					    <span clas="col-xs-0 pull-right">LIST</span>
					</button>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<ul class="grid0" style="display: none;">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/accesorios/accesorio04.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/accesorios/accesorio03.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/accesorios/accesorio02.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/accesorios/accesorio01.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
	...
	<div class="container">
		...
		<ul class="grid1" style="display:none">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/ropa/ropa04.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/ropa/ropa02.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/ropa/ropa06.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
...
<div class="container-fluid productos">
	<div class="container">
		<div class="row">
			<!--=====================================
			BARRA TITULO LO MAS VISTO
			======================================-->
			<div class="col-xs-12 tituloDestacado">
				<!--===================================== -->
				<div class="col-sm-6 col-xs-12">
					<h1><small>LOS MAS VISTOS</small></h1>
				</div>
				<!--===================================== -->
				<div class="col-sm-6 col-xs-12">
					<a href="lo-mas-visto">
		...
		<ul class="grid1">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-xs-6 enlaces">
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost/ecommerce_php/backend/vistas/img/productos/cursos/curso05.jpg" titulo="Curso de Boostrap" precio="10" tipo="virtual" peso="0" data-toggle="tooltip" title="Agregar al carrito de compras">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/cursos/curso04.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
				...
				<div class="col-xs-6 enlaces">
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost/ecommerce_php/backend/vistas/img/productos/cursos/curso04.jpg" titulo="Curso de Canvas y Javascript" precio="10" tipo="virtual" peso="0" data-toggle="tooltip" title="Agregar al carrito de compras">
							<i class="fa fa-shopping-cart" aria-hidden="true"></i>
						</button>
						<a href="#" class="pixelProducto">
							<button type="button" class="btn btn-default btn-xs" data-toogle="tooltip" title="Ver producto">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/cursos/curso02.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
				...
				<div class="col-xs-6 enlaces">
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost/ecommerce_php/backend/vistas/img/productos/cursos/curso02.jpg" titulo="Aprende Javascript desde cero" precio="10" tipo="virtual" peso="0" data-toggle="tooltip" title="Agregar al carrito de compras">
							<i class="fa fa-shopping-cart" aria-hidden="true"></i>
						</button>
						<a href="#" class="pixelProducto">
							<button type="button" class="btn btn-default btn-xs" data-toogle="tooltip" title="Ver producto">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" clas="pixelProducto">
						<img src="http://localhost/ecommerce_php/backend/vistas/img/productos/cursos/curso03.jpg" class="img-responsive">
					</a>
				</figure>
				<!--===================================== -->
				<h4>
